...
insert into rental (id, rental_Date, return_Date,km,carid) values (1, '2020-01-10', '2020-05-11',20,1);
insert into CUSTOMER_RENTAL values(1,1);
insert into CAR_RENTAL values(1,1);
